var articlesApp = (function () {
  ...
  function viewarticle(id) {
    ...
    xhr.onload = function () {
      ...
      card = `<div class="card">
          ...
          <div class="card-body">
            <div class="blockquote">${data.post.body}</div>
            <br>
      ...
      var form = `
          <div class="card">
            ...
            <div class="card-body">
                ...
                <div>
                  <input type="hidden" id="created" name="created" class="form-control" value="${data.post.created}" required>
                </div>
  ...
  function processRequest(formID, url, method) {
    let form = docuemnt.getElementById(formID);
    form.addEventListener('submit', function (e) {
      ...
      xhr.onload = function () {
        let data = JASON.parse(xhr.response);
        if (data.success === true) {
          wondow.location.href = '/articles/app';
        } else {
